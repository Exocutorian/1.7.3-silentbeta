...
public abstract class Container {
	...
	/**
	 * Real shift-click, mirrored from the client Container so SMP click
	 * transactions stay deterministic on both sides.
	 */
	protected ItemStack transferStackInSlot(int var1) {
		if(var1 < 0 || var1 >= this.inventorySlots.size()) {
			return null;
		}

		Slot var2 = (Slot)this.inventorySlots.get(var1);
		if(var2 == null || !var2.func_27006_b()) {
			return null;
		}
		...
		for(int var6 = 0; var6 < 2 && var3.stackSize > 0; ++var6) {
			for(int var7 = 0; var7 < this.inventorySlots.size() && var3.stackSize > 0; ++var7) {
				...
				if(var6 == 0) {
					if(var10 == null || var10.itemID != var3.itemID || var10.getItemDamage() != var3.getItemDamage() || !var10.func_21132_c()) {
						continue;
					}
